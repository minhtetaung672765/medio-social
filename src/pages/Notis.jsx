...
export default function Notis() {
    ...
    // query key "notis" is important for Real-time noti data update
    // this query key will be used from Web socket client side to update noti data
    // relate to AppSocket.jsx
